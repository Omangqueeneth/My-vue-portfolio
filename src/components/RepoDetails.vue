<template>
  <div id="repodetail">
    ...
    <div v-else class="repodetail-card">
      ...
      <p v-else>Error Page: <a :href="`https://Omangqueeneth.github.io/${details.name}`">Omangqueeneth.github.io/{{ details.name }}</a></p>
...
export default {
  ...
  methods: {
    fetchData: function () {
      this.loading = true;
      fetch(`https://api.github.com/repos/Omangqueeneth/${this.$route.params.id}`, {
        headers: {
      ...
      fetch(`https://api.github.com/repos/Omangqueeneth/${this.$route.params.id}/branches`, {
        headers: {
          Accept: 'application/json',
        },
      })
      ...
      fetch(`https://api.github.com/repos/Omangqueeneth/${this.$route.params.id}/deployments`, {
        headers: {
          Accept: 'application/json',
        },
      })
